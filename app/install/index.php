...
<html lang="en">
  ...
  <div class="container-fluid bgbody" style="max-width:800px;padding-top:10px;margin:auto">
  	<h1>Install Module Installation</h1>
  	<p class="p1">
	  ...
	  <?php }else{?>
			...
			<div class="control-group">
				...
				<div class="controls">
				  	<input class="input-xxlarge" type="text" id="LOG" name="LOG" value="data/install_module_dev.log"/>
			...
			<div class="control-group">
				...
				<div class="controls">
				  	...
				  	<span class="help-inline p1">This is the web path to folder that you copy install module sources (e.g http://yourdomain.com/modulename/)</span>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="APP_DB">MySql Database Name</label>
				<div class="controls">
				  	<input class="input-xxlarge" type="text" id="APP_DB" name="APP_DB" value="installmoduledb"/>
			...
			<div class="control-group">
				...
				<div class="controls">
				  	<input class="input-xxlarge" type="text" id="APP_USERNAME" name="APP_USERNAME" value="root"/>
			...
			<div class="control-group">
				...
				<div class="controls">
				  	...
				  	<span class="help-inline p1">MySql DB Host(Note: Add port number if you require(e.g. localhost:3307))</span>
				</div>
			</div>
			<div class="control-group">
		    	<div class="controls">
		      		<button id="testBtn" onclick="testDataBase();return false;" class="btn">Test Database Connectivity</button>
