...
$dateTimeZoneIndia = new DateTimeZone("Asia/Kolkata");
$dateTimeIndia = new DateTime("now", $dateTimeZoneIndia);
$dateTimeIndiaStr = $dateTimeIndia->format("Y-m-d H:i:s");
$dateTimeNow = date("Y-m-d H:i:s");

$diffHoursBetweenServerTimezoneWithGMT = (strtotime($dateTimeNow) - (strtotime($dateTimeIndiaStr) - 5.5*60*60))/(60*60);